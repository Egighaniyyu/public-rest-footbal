const ApiKey = "c5064999c0df4ac888edf4fb56308a19";
                ...
                info.onclick = (event) => {
                    ...
                    fetch(url, fetchHeader)
                        ...
                        .then(resInfo => {
                            dataModal = `
                            <tr>
                                <td><img src="${resInfo.crestUrl}"  alt="" width="100px" align="center"></td>
                            </tr>
                            <br><p>Nama Singkat &emsp;: ${resInfo.shortName} /&nbsp;${resInfo.tla}<br>
                            ...
                            No.Tlp  &emsp;&emsp;&emsp;&emsp;&nbsp;: ${resInfo.phone} <br>
